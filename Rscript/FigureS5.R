# =============================================================================
#   Figure S5 - colorectal neoplasia application, sensitivity analyses
# =============================================================================
...
#
#  Display order matches the main figure (see Rscript/Figure6.R): clusters run most
#  parsimonious first, and studies inside a cluster are ordered by disease
#  stage, Adenoma -> early -> late.
# =============================================================================
...
# =============================================================================
  ...
  study_order   <- order_studies_by_key(stage, W, cluster_order, stage_levels)
  ...
  ggsave(
    ...
    plot = g_A,
    width = 700, height = 250, units = "mm", dpi = 300
  )
...
# =============================================================================
  ...
  study_id  <- names(summary_stat_filter)
